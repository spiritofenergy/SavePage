...
public class Main {
    public static void main(String[] args) throws Exception {
       ...
       String name = "Random_Article.html";
        writeToFile(sourceCode, name);
    }
    ...
    public static void writeToFile(String str, String name ) throws Exception {

        BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\Marat\\Desktop\\test\\" + name));
        writer.write(str);
        writer.close();
    }
